...
export const useAuth = () => {
  ...
  const prepareFormData = (data: TypeLoginFormData | TypeSignupFormData, type: 'login' | 'signup') => {
  ...
  const getErrorFromMutation = (mutation: typeof loginMutation | typeof signupMutation): TypeAuthError | null => {
